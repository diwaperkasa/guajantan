...
var galleryPostCategory = document.querySelectorAll('.gallery-post-category');
galleryPostCategory.forEach(function (gallery) {
  new (flickity__WEBPACK_IMPORTED_MODULE_1___default())(gallery, {
    cellAlign: 'left',
    pageDots: false,
    autoPlay: 3000,
    wrapAround: true
...
var relatedPostGallery = document.querySelector('.related-post-gallery');
if (relatedPostGallery) {
  new (flickity__WEBPACK_IMPORTED_MODULE_1___default())(relatedPostGallery, {
    cellAlign: 'left',
    pageDots: false,
    autoPlay: 3000,
    wrapAround: true
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          case 0:
            ...
            button.after(loader);
            _context2.n = 2;
            return fetch("/wp-admin/admin-ajax.php?".concat(new URLSearchParams(args))).then(/*#__PURE__*/function () {
          ...
          case 3:
            articleContainer = document.querySelector('.post-archive-container');
            if (articleContainer) {
              _context2.n = 4;
              break;
            }
          ...
          case 4:
            res.data.forEach(function (row) {
              articleContainer.insertAdjacentHTML('beforeend', "<li class=\"mb-4\">\n                        ".concat(row, "\n                    </li>"));
            });
